...
class HttparseProtocol(asyncio.Protocol):
    def __init__(
        ...
        self.pipeline: Deque[Tuple[RequestResponseCycle, "ASGIApp"]] = deque()
    ...
    def connection_made(  # type: ignore[override]
        ...
        if self.logger.level <= TRACE_LOG_LEVEL:  # pragma: to be covered
    ...
    def _unset_keepalive_if_required(self) -> None:
        if self.timeout_keep_alive_task is not None:  # pragma: to be covered
    ...
    def pause_writing(self) -> None:
        ...
        """
        self.flow.pause_writing()  # pragma: to be covered

    def resume_writing(self) -> None:
        """
        Called by the transport when the write buffer drops below the low water mark.
        """
        self.flow.resume_writing()  # pragma: to be covered
